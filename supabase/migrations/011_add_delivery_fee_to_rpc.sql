-- =====================================================
-- FIX: rpc_create_order - Add p_delivery_fee parameter
-- Issue: Delivery fee not saved when paid via VNPAY
-- =====================================================
...
BEGIN
    ...
    -- Get delivery fee: use provided value or fall back to restaurant default
    ...
    IF v_promotion_id IS NOT NULL THEN
        UPDATE promotions SET usage_count = usage_count + 1 WHERE id = v_promotion_id;
